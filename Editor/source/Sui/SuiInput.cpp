...
void SuiInput::Update(float deltaTime)
{
	...
	MX_ON_WIN = pos.x - WIN_MOVE_X;
	MY_ON_WIN = pos.y - WIN_MOVE_Y;

	AppInfo* appInfo = AppInfo::GetInstance();

	MX = pos.x - WIN_MOVE_X - appInfo->viewX;
	MY = pos.y - WIN_MOVE_Y - appInfo->viewY;

	MX = appInfo->baseWindowW * MX / appInfo->viewW;
	MY = appInfo->baseWindowH * MY / appInfo->viewH;
