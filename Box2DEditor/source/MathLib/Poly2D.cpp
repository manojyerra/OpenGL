...
bool Poly2D::Contains(Point* p)
{
	...
	{
		return Triangle2D(pointsVec[0], pointsVec[1], pointsVec[2]).Contains(p);
	}
	else if(pointsSize == 4)
	{
		Triangle2D triangle2D_1(pointsVec[0], pointsVec[1], pointsVec[2]);
		Triangle2D triangle2D_2(pointsVec[0], pointsVec[2], pointsVec[3]);
		return triangle2D_1.Contains(p) || triangle2D_2.Contains(p);
	}
    else
    {
