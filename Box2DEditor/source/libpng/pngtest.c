...
#  endif
   ...
   for (;;)
   {
      png_size_t num_in, num_out;
         ...
         //num_in = fread(inbuf, 1, 1, fpin);	//Changed to MYFILE
         //num_out = fread(outbuf, 1, 1, fpout);	//Changed to MYFILE

         num_in = myFileRead(inbuf, 1, 1, fpin);
         num_out = myFileRead(outbuf, 1, 1, fpout);
