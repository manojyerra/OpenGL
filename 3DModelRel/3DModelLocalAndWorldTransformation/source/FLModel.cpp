...
void FLModel::SetTextureEnable(bool enable)			{	_isTextureEnabled = enable;		}
bool FLModel::IsTextureEnabled()					{	return _isTextureEnabled;		}
void FLModel::EnableWireFrame(bool enable)			{	_wireFrameEnabled = enable;		}
bool FLModel::IsWireFrameEnabled()					{	return _wireFrameEnabled;		}
void FLModel::EnableBoundingBox(bool enable)		{	_boundingBoxEnabled = enable;	}
bool FLModel::IsBoundingBoxEnabled()				{	return _boundingBoxEnabled;		}
void FLModel::EnableBounding2DRect(bool enable)		{	_bounding2DRectEnabled = enable;}
