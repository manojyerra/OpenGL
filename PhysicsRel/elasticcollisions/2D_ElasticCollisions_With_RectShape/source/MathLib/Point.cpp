...
void Point::SetRotation(int axis, float angleInDegrees, float centerX, float centerY, float centerZ)
{
	...
	if(axis == Z_AXIS)
	{
		...
		x = xx*cosf(angleInDegrees) - yy*sinf(angleInDegrees);
		y = xx*sinf(angleInDegrees) + yy*cosf(angleInDegrees);
	}
	else if(axis == X_AXIS)
	{
		float yy = y;
		...
		y = yy*cosf(angleInDegrees) - zz*sinf(angleInDegrees);
		z = yy*sinf(angleInDegrees) + zz*cosf(angleInDegrees);
	}
	else if(axis == Y_AXIS)
	{
		float zz = z;
		...
		z = zz*cosf(angleInDegrees) - xx*sinf(angleInDegrees);
		x = zz*sinf(angleInDegrees) + xx*cosf(angleInDegrees);
	}
